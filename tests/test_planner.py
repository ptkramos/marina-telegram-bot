"""
Testes Automatizados Offline para o InternalPlanner da Marina Salles (v3.7.0).
"""
import sys
import unittest
import tempfile
...
class TestInternalPlanner(unittest.TestCase):
    ...
    def test_apply_plan_effects_creates_pending_event(self):
        ...
        self.assertAlmostEqual(emocoes["affection"]["valor"], 0.856, places=3)  # D14: vínculo anda devagar (×0,4)
