"""Gemini/Antigravity handoff for stage 12; Codex does not run this suite."""
...
RESULT = ROOT / 'data' / 'relationship_proactivity_validation.v365.json'
