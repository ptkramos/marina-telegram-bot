...
- **LoRAs de ocasião** (`civitai_images.CONDITIONAL`, entram quando a cena pede):
  ...
  - **Better Pussy v4.2.1 (0.8)** foi aprovado: melhora o aspecto, mas não a cor, e a foto fica um pouco mais pálida. Entra só com a vulva à mostra ("legs spread/open", "showing her pussy"), com o gatilho `hairless_pussy`, e **nunca junto com o Spread**: se os dois ligarem, fica só o Spread (`EXCLUSIVE`).
