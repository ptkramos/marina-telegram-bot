...
- **LoRAs de ocasião** (`civitai_images.CONDITIONAL`, entram quando a cena pede):
  ...
  - **Oiled Skin** (Krea 2 v1.0, gatilho `OiledSkin`) entra só na foto adulta, quando a cena fala em óleo, creme ou hidratante (pós-banho provocando). Em 0.4 e 0.6 ficou forte demais e pareceu esperma. Agora o gatilho pede **óleo transparente**, sem creme nem gotas brancas, e a força caiu pra **0.25**. Testes de 0.2, 0.3 e sem o LoRA foram feitos com ela no banheiro espalhando o óleo. Quando ele entra, **a molhada sai** (`EXCLUSIVE`), senão o brilho dobra. Correção: o gatilho entrava como "Oiledskin" (`.capitalize()`); agora a caixa das letras é preservada.
