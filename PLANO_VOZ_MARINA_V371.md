...
- **LoRAs de ocasião** (`civitai_images.CONDITIONAL`, entram quando a cena pede):
  ...
  - **Oiled Skin** (Krea 2 v1.0, gatilho `OiledSkin`) entra só na foto adulta, quando a cena fala em óleo, creme ou hidratante (pós-banho provocando). Está em 0.5 até o Patrick escolher entre os testes de 0.4 e 0.6. Quando ele entra, **a molhada sai** (`EXCLUSIVE`), senão o brilho dobra. Correção: o gatilho entrava como "Oiledskin" (`.capitalize()`); agora a caixa das letras é preservada.
